...
class GroupTests {
	...
	void createMemberEach() {
		member1 = Member.createMember("user1@gmail.com", "유저1", Gender.MALE);
		member2 = Member.createMember("user2@gmail.com", "유저2", Gender.FEMALE);
		member3 = Member.createMember("user3@gmail.com", "유저3", Gender.MALE);
	}
